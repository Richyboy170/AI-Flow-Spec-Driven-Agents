// Inline SVG icons (no emoji, no external icon dependency). Lucide-style 1.5px
// stroke, sized via the `className` prop and inheriting currentColor.
...
export function SparkleIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg {...base} className={className}>
      <path d="M12 3l1.9 4.6L18.5 9.5 13.9 11.4 12 16l-1.9-4.6L5.5 9.5 10.1 7.6 12 3z" />
      <path d="M19 14l.7 1.7 1.8.7-1.8.7L19 19l-.7-1.9-1.8-.7 1.8-.7L19 14z" />
    </svg>
  )
}

export function DocumentIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg {...base} className={className}>
